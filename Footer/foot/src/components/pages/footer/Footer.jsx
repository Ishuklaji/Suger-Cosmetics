    ...
    <>
      <div className={styles.container}>
        <div className={styles.div1}>
          <img style={{ height: "120px" }} src="https://in.sugarcosmetics.com/Footer_sugar_icon.png" alt="" />
        </div>
        <div className={styles.div2}>
          ...
          <a href='https://twitter.com/trySUGAR' target="_blank"><img className={styles.imgdiv1} src="https://in.sugarcosmetics.com/desc-images/Twitter.svg" alt="" /></a>
        ...
        <div style={{ marginLeft: "90px", marginTop: "-5px", display: "flex", gap: "70px" ,fontFamily:"Roboto,sans-serif"}}>
          <div>
            <div style={{ display: "flex" }}><img style={{ marginTop: "20px", width: "20px", height: "15px" ,fontFamily:"Roboto,sans-serif"}} src="https://in.sugarcosmetics.com/desc-images/phone_android_white.svg" alt="" /><p style={{ color: "white", fontSize: "18px", fontWeight: "540" }}>Call us at</p></div>
            <p style={{ fontSize: "18px", color: "rgb(153,153,153)", marginTop: "-10px",textAlign:"left" ,fontFamily:"Roboto,sans-serif"}}>1800-209-9933</p>
            <p style={{ fontSize: "small", color: "rgb(153,153,153)", marginTop: "-15px" ,fontFamily:"Roboto,sans-serif"}}>Monday to Friday : 9 AM to 7 PM</p>
          </div>
          <div>
            <p style={{ color: "white", fontSize: "18px", fontWeight: "700" ,textAlign:"left",fontFamily:"Roboto,sans-serif"}}>Support</p>
            <p style={{ fontSize: "18px", color: "#969696", marginTop: "-10px",fontFamily:"Roboto,sans-serif" }}>hello@sugarcosmetics.com</p>
          </div>
          <div>
            <p style={{ color: "white", fontSize: "18px", fontWeight: "700" ,textAlign:"left",fontFamily:"Roboto,sans-serif"}}>Careers</p>
            <a style={{textDecoration:"none" }} href="https://in.sugarcosmetics.com/careers"><p style={{ fontSize: "18px", color: "rgb(153,153,153)", marginTop: "-10px",fontFamily:"Roboto,sans-serif" }}>We're hiring!</p></a>
          </div>
          <div>
            <p style={{ color: "white", fontSize: "18px", fontWeight: "700",textAlign:"left" ,fontFamily:"Roboto,sans-serif"}}>Press & Media</p>
            <p style={{ fontSize: "17px", color: "rgb(153,153,153)", marginTop: "-10px" ,fontFamily:"Roboto,sans-serif" }}>pr@sugarcosmetics.com</p>
          </div>
          <div>
            <p style={{ color: "white", fontSize: "17px", fontWeight: "700" ,textAlign:"left" ,fontFamily:"Roboto,sans-serif"}}>Influencer Collab</p>
            <a href='https://blog.sugarcosmetics.com/collab' target="_blank" style={{  textDecoration: "none"}}><p style={{ fontSize: "18px", color: "rgb(153,153,153)", marginTop: "-12px", textDecoration: "none", paddingTop: "-20px" ,textAlign:"left",fontFamily:"Roboto,sans-serif"}}>Join Us</p></a>
          </div>
        </div>
        <hr style={{ marginLeft: "40px", marginRight: "40px", marginTop: "42px" }} />
          ...
          <div className={styles.div3}>
            <div className={styles.innerdiv3}>
              <div className={styles.gtc}>
                ...
                <p style={{ width: "400px", fontSize: "14px", color: "rgb(131,131,131)" ,marginTop:"-15px" }}>Tap into a better shopping experience.</p>
              </div>
