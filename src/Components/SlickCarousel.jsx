...
import { Button,   IconButton,AspectRatio} from '@chakra-ui/react'
          ...
          <Slider {...settings2} className={styles.bestsellersSlider} >
             ...
             <div  className={styles.imageCss} >
              ...
              <div className={styles.productDescription}>
                ...
                <IconButton variant='outline' fontSize='18px' as={FiHeart} color='black' p='3px'/>
              <Button w='180px' color='white' bg='black' variant='solid'>ADD TO CART</Button>
                </div>
                </div>
         )}
          </Slider>
        ...
        <Slider {...settings2} className={styles.justinSlider}>
           ...
           <div className={styles.imageCss2}>
            ...
            <div className={styles.productDescription}>
              ...
              <div className={styles.buttongrp}>
              <IconButton variant='outline' fontSize='18px' as={FiHeart} color='black' p='3px'/>
             <Button w='150px' color='white' bg='black' variant='solid'>ADD TO CART</Button>
              </div>
              </div>
       )}
        </Slider>
...
<div className={styles.supersavers}>
        <h1 className={styles.headings}>SUPER SAVERS</h1>
          <Slider {...settings2} className={styles.bestsellersSlider} >
             ...
             <div  className={styles.imageCssSS} 
             >
              <img   src={image.url} alt="img"/>
              <div className={styles.productDescription}>
                     {image.description}
